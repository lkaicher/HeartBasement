...
{	
	...
	{		
		...
		public static IInventory Washer         { get { return PowerQuest.Get.GetInventory("Washer"); } }
		public static IInventory Wrench         { get { return PowerQuest.Get.GetInventory("Wrench"); } }
